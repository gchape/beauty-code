const TermsOfService = () => (
  <div className="mx-auto px-5 py-10 text-black bg-white font-serif">
    ...
    <p className="text-sm leading-relaxed mb-8">
      ...
      bound by all of these Legal Terms. The Services are intended for users who
    ...
    <div className="mb-7">
      ...
      <p className="text-sm leading-relaxed">
        ...
        non-commercial use. No part of the Services and no Content or Marks may
        ...
        expressly granted to you. Any breach of these Intellectual Property
    ...
    <div className="mb-7">
      ...
      <p className="text-sm leading-relaxed">
        ...
        Services through automated or non-human means; (7) you will not use the
    ...
    <div className="mb-7">
      ...
      <p className="text-sm leading-relaxed">
        ...
        reliable, current, or free of other errors. All products are subject to
    ...
    <div className="mb-7">
      ...
      <p className="text-sm leading-relaxed">
        ...
        "Contributions"). When you create or make available any Contributions,
        you thereby represent and warrant that your Contributions comply with
        all applicable laws and do not infringe upon the rights of any third
        party. Any use of the Services in violation of the foregoing violates
    ...
    <div className="mb-7">
      ...
      <p className="text-sm leading-relaxed">
        ...
        hosted in Georgia. If you access the Services from any other region of
        ...
        Georgia, then through your continued use of the Services, you are
        transferring your data to Georgia, and you expressly consent to have
    ...
    <div className="mb-7">
      ...
      <p className="text-sm leading-relaxed">
        ...
        Brussels, Avenue Louise, 146) according to the Rules of this ICAC. The
        number of arbitrators shall be one (1). The seat of arbitration shall be
    ...
    <div className="mb-7">
      ...
      <p className="text-sm leading-relaxed">
        ...
        rights and obligations to others at any time. If any provision or part
        of a provision of these Legal Terms is determined to be unlawful, void,
